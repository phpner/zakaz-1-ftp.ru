...
function smtpmail($mail_to, $subject, $message, $headers='') {
        ...
        //Настройки почты
        $config['smtp_username'] = 'info@vadshop.ru';  //Смените на имя своего почтового ящика из ISPManager.
        $config['smtp_password'] = 'vad10080810';  //Измените пароль.
        $config['smtp_from']     = 'vadshop'; //Ваше имя - или имя Вашего сайта. Будет показывать при прочтении в поле "От кого".
