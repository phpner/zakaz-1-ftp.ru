...
<div class="big-pic--theme9" data-block-layout="110241" id="_lp_block_14394441">
    <div class="big-pic-wrapper center-center" style="background-image: url('/img/head.png');">
        <div class="big-pic-inner">
            <div class="text-part">
                <div class="slogan">Производство и реализация мягкой и корпусной мебели</div>
        ...
        <div class="text_blocks">
            <div class="text_j right">
                ...
                <div class="text_wrap clear-self">
                    <div class="pic"><img alt="При производстве мебели по индивидуальным эскиза" src="/img/rectangle_1.png">
                    </div>
            ...
            <div class="text_j left">
                ...
                <div class="text_wrap clear-self">
                    <div class="pic"><img alt="Мы гарантируем, что заказанная у нас мебель, украс" src="/img/rectangle_2.png">
                    </div>
